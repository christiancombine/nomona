...
$pantsDir = $_SERVER["DOCUMENT_ROOT"] . "/UserGenerated/pants/";
$assetDir = $_SERVER["DOCUMENT_ROOT"] . "/asset/assets/";
$thumbDir = $_SERVER["DOCUMENT_ROOT"] . "/thumbs/catalog/";
$imageUrlBase = "http://www.nomona.fit/UserGenerated/pants/";

if ($_SERVER["REQUEST_METHOD"] === "POST") {

    $file = $_FILES["file"];

    $name = $_POST["name"] ?? "Pant";
    ...
    $targetImage = $pantsDir . $filename;
    if (!file_exists($pantsDir)) {
        die("Pants directory missing: " . $pantsDir);
    }
