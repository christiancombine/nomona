...
<div id="Container">
    ...
    <div id="Body">
    <div id="info" style="position: fixed; z-index: 1; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(100,100,100,0.25);" hidden="">
    ...
    <font face="Verdana">
        ...
        <div id="MembershipOptions">
            <div id="OneMonth">
                <div class="BuildersClubButton"><a href="#" onclick="document.getElementById('info').hidden = false"><img src="../images/BuyBCMonthly.png" style="border-width:0px;"></a></div>
                <div class="Label"><a href="#" onclick="document.getElementById('info').hidden = false">Join Monthly</a></div>
            </div>
            <div id="SixMonths">
                <div class="BuildersClubButton"><a href="#" onclick="document.getElementById('info').hidden = false"><img src="../images/BuyBC6Months.png" style="border-width:0px;"></a></div>
                <div class="Label"><a href="#" onclick="document.getElementById('info').hidden = false">Join for 6 Months</a></div>
            </div>
            <div id="TwelveMonths">
                <div class="BuildersClubButton"><a href="#" onclick="document.getElementById('info').hidden = false"><img src="../images/BuyBC12Months.png" style="border-width:0px;"></a></div>
        ...
        <div id="WhyJoin">
            ...
            <ul class="MembershipBenefits">
                ...
                <li class="Benefit_RobuxAllowance">Earn a daily income of 15 MONBUX</li>
                <li class="Benefit_SuppressAds">Never see any outside ads on NOMONA</li>
                <li class="Benefit_ExclusiveHat">Receive the exclusive Builders Club construction hard hat</li>
            </ul>
            <p>Product is Windows-only. For more information, read our <a href="error.php">Builders Club FAQs</a>.</p>
    <!--        <h3>Not Ready Yet?</h3>
            <ul class="MembershipBenefits">
            <li class="Benefit_RobuxAllowance">You can also <a href="Currency.aspx">grab ROBUX</a> by not donating us. We will offer you some as our way of saying thank you. </li>
            <ul>
        </ul></ul> --> </div>
